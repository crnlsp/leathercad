# Roadmap to 1.0 — the record

> **Archive.** This is the roadmap as it stood when v1.0.1 shipped (2026-09-24), kept whole: every
> slice from 0.1 to 8.6 with what it built, what it found, and the gotchas worth not rediscovering.
> It is not updated any more. What comes next is in [`docs/roadmap.md`](../roadmap.md); how work is
> done is in [`CONTRIBUTING.md`](../../CONTRIBUTING.md); what shipped is in
> [`CHANGELOG.md`](../../CHANGELOG.md). Slice numbers used here (4.3, 7.4c, …) keep their meaning,
> and the dated specs in `docs/superpowers/` still refer to them.
...
- **What is left needs a person or credentials:** the manual gate in
  [`release-1.0-validation.md`](../release-checklist.md), which includes the physical print on
